            ...
            <div id="Layer1" style="width:350px; height:350px; overflow: scroll;">
                ...
                <div class="card-panel  chat-panel ">
                    ...
                    <div class="col s12 " id="chat-box">
                        <div id="chat-messages" class="left" data-chat-refresh="<?php echo e(config('config.enable_chat_refresh')); ?>" data-chat-refresh-duration="<?php echo e(config('config.chat_refresh_duration')); ?>"></div>
                    </div>
                    <div class="">
