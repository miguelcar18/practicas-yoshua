...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicons-->
        <link rel="apple-touch-icon-precomposed" href="<?php echo e(asset('materialize/images/favicon/apple-touch-icon-152x152.png')); ?>">
        <!-- For iPhone -->
        ...
        <link href="<?php echo e(asset('materialize/css/layouts/page-center.css')); ?>" type="text/css" rel="stylesheet" media="screen,projection">
