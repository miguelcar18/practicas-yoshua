                ...
                <div class="col s12">
                    <div class="input-field col s6">
                        ...
                        <div id="enable_two_factor_auth_field">
                            <div class="input-field col s4">
                                ...
                                <p><?php echo Form::select('two_factor_auth_type', [
                                    '1'=>'Email',
                                    '0'=>'SMS'
                    ...
                    <div class="input-field col s6">
                        ...
                        <div id="enable_lock_screen_field">
                            <div class="input-field col s6">
                                <p><?php echo Form::label('lock_screen_timeout',trans('messages.lock_screen').' '.trans('messages.timeout').' (In Min)',[]); ?></p>
                    ...
                    <div class="input-field col s6">
                        ...
                        <div id="enable_throttle_field">
                            <div class="input-field col s2">
                                <p><?php echo Form::label('throttle_attempt','Attempt',[]); ?></p>
                                <?php echo Form::input('text','throttle_attempt',(config('config.throttle_attempt')) ? : '',[]); ?>

                            </div>
                            <div class="input-field col s4">
                                <p><?php echo Form::label('throttle_lockout_period','Lockout Period (In Min)',[]); ?></p>
