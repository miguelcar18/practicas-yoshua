			...
			<div class="col-sm-6">
			  ...
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="error_display" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.error_display') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  	<div class="col-md-6">
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="multilingual" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.multilingual') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  </div>
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_ip_filter" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_ip_filter') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  	<div class="col-md-6">
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_activity_log" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_activity_log') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  </div>
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_email_template" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_email_template') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  	<div class="col-md-6">
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_to_do" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_to_do') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  </div>
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_message" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_message') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  	<div class="col-md-6">
			  ...
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_backup" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_backup') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  	<div class="col-md-6">
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_custom_field" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_custom_field') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
			  	</div>
			  </div>
			  <div class="row">
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="enable_group_chat" type="checkbox" class="switch-input enable-show-hide" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_group_chat') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>
				  <div id="enable_group_chat_field">
					  <div class="form-group">
		                ...
		                <div class="checkbox">
		                <input name="enable_chat_refresh" type="checkbox" class="switch-input enable-show-hide" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.enable_chat_refresh') == 1) ? 'checked' : ''); ?> data-off-value="0">
		                </div>
		              </div>
				  </div>
				  ...
				  <div class="form-group">
	                ...
	                <div class="checkbox">
	                <input name="maintenance_mode" type="checkbox" class="switch-input enable-show-hide" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" <?php echo e((config('config.maintenance_mode') == 1) ? 'checked' : ''); ?> data-off-value="0">
	                </div>
	              </div>				  
