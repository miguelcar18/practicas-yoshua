                                    ...
                                    <div class="row">
                                        ...
                                        @if(!$user->hasRole(DEFAULT_ROLE))
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('role_id[]',$roles,$user_roles,['class'=>'form-control select2me','style' => 'width:100%;','multiple' => 'multiple'])!!}
                                            </div>
                                        @endif
                                          <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br />
                                                {!! Form::select('country_id', config('country'),$user->Profile->country_id,['class'=>'form-control select2me','placeholder'=>trans('messages.country'),'style' => 'width:100%;'])!!}
                                            </div>
                        ...
                        <div class="tab-pane fade in" id="email-tab">
                            <div class="panel panel-default m-t-10">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        {!! Form::select('template_id', [null=>trans('messages.select_one')] + $templates,'',['class'=>'form-control input-xlarge select2me','id'=>'template_id','style' => 'width:100%;'])!!}
                                    </div>
                                    <div class="form-group">
