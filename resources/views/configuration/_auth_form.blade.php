	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<div class="checkbox">
					<input name="login" type="checkbox" class="switch-input" data-size="mini" data-on-text="Email" data-off-text="Username" value="1" {{ (config('config.login') == '1') ? 'checked' : '' }} data-off-value="0">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="checkbox">
					<input name="enable_admin_approval" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" {{ (config('config.enable_admin_approval') == 1) ? 'checked' : '' }} data-off-value="0">
				</div>
			</div>
		</div>
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="checkbox">
					<input name="enable_remember_me" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" {{ (config('config.allow_remember_me') == 1) ? 'checked' : '' }} data-off-value="0">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="checkbox">
					<input name="enable_forgot_password" type="checkbox" class="switch-input" data-size="mini" data-on-text="Yes" data-off-text="No" value="1" {{ (config('config.enable_forgot_password') == 1) ? 'checked' : '' }} data-off-value="0">
				</div>
			</div>
			<div class="form-group">
