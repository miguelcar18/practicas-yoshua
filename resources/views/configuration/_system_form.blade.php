        ...
        <div class="card-panel">
           ...
           {{-- <div class="row">
                ...
                <div class="col-md-6">
                    <div class="input-field col s6">
                        <p>
                            <input name="enable_custom_field" type="checkbox" class="checkbox-input filled-in" id="enable_custom_field" value="1" {{ (config('config.enable_custom_field') == 1) ? 'checked' : '' }} data-off-value="0">
                            {!! Form::label('enable_custom_field',trans('messages.enable').' '.trans('messages.custom').' '.trans('messages.field'),[])!!}
                        </p>
                    </div>
                </div>
            </div>--}}
