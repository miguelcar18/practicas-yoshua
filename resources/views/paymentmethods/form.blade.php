<div class="row">
    <div class="col s12 m12 l12">
        <div class="card-panel">
            <h4 class="header2">Paymentmethods</h4>
            <div class="row">
                <div class="col s12">
                    
                    <div class="input-field col s6">
                        <input type="text" name="name" class="" required="required" id="name" value="{{$paymentmethod->name}}">
                        <label>{{ trans('messages.name') }}</label>
                    </div>
                    
                    <div class="input-field col s6">
                        <input type="text" name="description" class="" required="required" id="description" value="{{$paymentmethod->description}}">
