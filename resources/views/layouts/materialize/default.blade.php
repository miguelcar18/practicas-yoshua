                ...
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        ...
                        <ul class="right hide-on-med-and-down">
                            <li><a href="javascript:void(0);" class="waves-effect waves-block waves-light translation-button"  data-activates="translation-dropdown"><img src="{{asset('materialize/images/flag-icons/United-States.png')}}" alt="USA" /></a>
                            </li>
                                    ...
                                    <div class="collapsible-body favorite-associates">
                                        <div class="favorite-associate-list chat-out-list row">
                                            <div class="col s4">
                                                ...
                                                <img src="{{asset('materialize/images/avatar.jpg')}}" alt="" class="circle responsive-img online-user valign profile-image">
                                            </div>
                                            <div class="col s8">
                                                <p>Eileen Sideways</p>
