...
Class PermissionController extends Controller {
    ...
    public function lists() {
        ...
        foreach ($permissions as $permission) {
            $rows[] = array(
                ((!$permission->is_default) ? '<div class="row"><div class="col s6">' .
                        //'<a href="#" data-href="/permission/' . $permission->id . '/edit" class="col s1 " style="font-size:20px" data-toggle="modal"  data-target="#myModal" > <i class="mdi-editor-mode-edit" data-toggle="tooltip" title="' . trans('messages.edit') . '"></i></a>' .
                        '<a href="/permission/' . $permission->id . '/edit" class="col s1 " style="font-size:20px" data-toggle="modal"  > <i class="mdi-editor-mode-edit" data-toggle="tooltip" title="' . trans('messages.edit') . '"></i></a>' .
